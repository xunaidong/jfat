 ...
 * an example round-trip using {@link cn.jfat.commons.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     cn.jfat.commons.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     cn.jfat.commons.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
