...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link cn.jfat.commons.collect.BiMap BiMap} (or can be one), you
   * can use {@link cn.jfat.commons.collect.Maps#asConverter Maps.asConverter} instead to get a
