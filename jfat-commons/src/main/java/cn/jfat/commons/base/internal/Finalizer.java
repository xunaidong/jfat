...
package cn.jfat.commons.base.internal;
...
public class Finalizer implements Runnable {
  ...
  private static final Logger logger
      = LoggerFactory.getLogger(Finalizer.class.getName());

  /** Name of FinalizableReference.class. */
  private static final String FINALIZABLE_REFERENCE
      = "cn.jfat.commons.base.FinalizableReference";
  ...
  public static void startFinalizer(
    ...
    try {
      ...
      logger.info("Failed to clear thread local values inherited"
  ...
  private boolean cleanUp(Reference<?> reference) {
    ...
    do {
      ...
      try {
        ...
        logger.info("Error cleaning up after reference.", t);
      }
  ...
  public static Field getInheritableThreadLocalsField() {
    try {
      ...
      logger.info("Couldn't access Thread.inheritableThreadLocals."
