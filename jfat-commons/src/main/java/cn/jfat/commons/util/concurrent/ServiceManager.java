 ...
 */
package cn.jfat.commons.util.concurrent;
...
import static cn.jfat.commons.base.Predicates.equalTo;
import static cn.jfat.commons.base.Predicates.in;
import static cn.jfat.commons.base.Predicates.instanceOf;
import static cn.jfat.commons.base.Predicates.not;
import static cn.jfat.commons.util.concurrent.Service.State.FAILED;
import static cn.jfat.commons.util.concurrent.Service.State.NEW;
import static cn.jfat.commons.util.concurrent.Service.State.RUNNING;
import static cn.jfat.commons.util.concurrent.Service.State.STARTING;
import static cn.jfat.commons.util.concurrent.Service.State.STOPPING;
import static cn.jfat.commons.util.concurrent.Service.State.TERMINATED;
...
import cn.jfat.commons.base.Supplier;
import cn.jfat.commons.collect.Collections2;
import cn.jfat.commons.collect.ImmutableCollection;
import cn.jfat.commons.collect.ImmutableList;
import cn.jfat.commons.collect.ImmutableMap;
import cn.jfat.commons.collect.ImmutableMultimap;
import cn.jfat.commons.collect.ImmutableSet;
import cn.jfat.commons.collect.ImmutableSetMultimap;
import cn.jfat.commons.collect.Lists;
import cn.jfat.commons.collect.Maps;
import cn.jfat.commons.collect.Multimaps;
import cn.jfat.commons.collect.Multiset;
import cn.jfat.commons.collect.Ordering;
import cn.jfat.commons.collect.SetMultimap;
import cn.jfat.commons.collect.Sets;
import cn.jfat.commons.util.concurrent.ListenerCallQueue.Callback;
import cn.jfat.commons.util.concurrent.Service.State;
